...
interface ListFoodCategoriesRemoteDatasource {
    suspend fun getListFoodCategoriesBeef() : Response<ListFoodCategoriesResponseModel>
    suspend fun getListFoodCategoriesChicken() : Response<ListFoodCategoriesResponseModel>
    suspend fun getListFoodCategoriesGoat() : Response<ListFoodCategoriesResponseModel>
